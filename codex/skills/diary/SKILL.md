---
name: diary
description: Capture a session diary entry in ~/.codex/memory/diary for cross-session continuity. Use when the user asks to save a session summary, log decisions, or record next steps.
---
...
Codex doesn't persist between sessions. This skill creates diary entries that future instances can reference to understand context, decisions, and learnings.

## What to Capture

Create a diary entry in `~/.codex/memory/diary/` with filename `YYYY-MM-DD-HH-MM-topic.md`:
